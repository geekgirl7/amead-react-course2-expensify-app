...
// An excellent Anki question:
// const store=createStore(combineReducers({
//   expenses: expensesReducer,
//   filter: filtersReducer
//
//   // ALWAYS CHECK FOR TYPOS!!!
//   // this code will generate a '_ref4 is undefined' error
//   // because filter: filtersReducer should be:
//
//   // ***filterS***: filtersReducer (all lower case, of course!)
//  
//   // Note: this didn't show up as an error until calling
//   // getVisibleExpenses, because we weren't working on filters yet
